...
sub adjust_phases {
    ...
    remove_flags($phases, qw(after_save_localized_file after_load_file after_load_source_file_for_processing before_save_localized_file before_deserialize_ts_file after_serialize_ts_file));
